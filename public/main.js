...
*/const ht=!(window.ShadyDOM&&window.ShadyDOM.inUse);let dt,ut;function pt(t){dt=(!t||!t.shimcssproperties)&&(ht||Boolean(!navigator.userAgent.match(/AppleWebKit\/601|Edge\/15/)&&window.CSS&&CSS.supports&&CSS.supports("box-shadow","0 0 0 var(--foo)")))}window.ShadyCSS&&void 0!==window.ShadyCSS.cssBuild&&(ut=window.ShadyCSS.cssBuild);const ft=Boolean(window.ShadyCSS&&window.ShadyCSS.disableRuntime);window.ShadyCSS&&void 0!==window.ShadyCSS.nativeCss?dt=window.ShadyCSS.nativeCss:window.ShadyCSS?(pt(window.ShadyCSS),window.ShadyCSS=void 0):pt(window.WebComponents&&window.WebComponents.flags);const mt=dt;
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
let ue,pe,fe=/(url\()([^)]*)(\))/g,me=/(^\/[^\/])|(^#)|(^[\w-\d]*:)/;function ge(t,e){if(t&&me.test(t))return t;if("//"===t)return t;if(void 0===ue){ue=!1;try{const t=new URL("b","http://a");t.pathname="c%20d",ue="http://a/c%20d"===t.href}catch(t){}}if(e||(e=document.baseURI||window.location.href),ue)try{return new URL(t,e).href}catch(e){return t}return pe||(pe=document.implementation.createHTMLDocument("temp"),pe.base=pe.createElement("base"),pe.head.appendChild(pe.base),pe.anchor=pe.createElement("a"),pe.body.appendChild(pe.anchor)),pe.base.href=e,pe.anchor.href=t,pe.anchor.href||t}function _e(t,e){return t.replace(fe,function(t,i,r,o){return i+"'"+ge(r.replace(/["']/g,""),e)+"'"+o})}function be(t){return t.substring(0,t.lastIndexOf("/")+1)}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const Ve="shady-unscoped";function je(t){return Ue.import(t)}function qe(t){const e=_e((t.body?t.body:t).textContent,t.baseURI),i=document.createElement("style");return i.textContent=e,i}function We(t){const e=t.trim().split(/\s+/),i=[];for(let t=0;t<e.length;t++)i.push(...Ke(e[t]));return i}function Ke(t){const e=je(t);if(!e)return console.warn("Could not find style data in module named",t),[];if(void 0===e._styles){const t=[];t.push(...Ye(e));const i=e.querySelector("template");i&&t.push(...Je(i,e.assetpath)),e._styles=t}return e._styles}function Je(t,e){if(!t._styles){const i=[],r=t.content.querySelectorAll("style");for(let t=0;t<r.length;t++){let o=r[t],n=o.getAttribute("include");n&&i.push(...We(n).filter(function(t,e,i){return i.indexOf(t)===e})),e&&(o.textContent=_e(o.textContent,e)),i.push(o)}t._styles=i}return t._styles}function Ye(t){const e=[],i=t.querySelectorAll("link[rel=import][type~=css]");for(let t=0;t<i.length;t++){let r=i[t];if(r.import){const t=r.import,i=r.hasAttribute(Ve);if(i&&!t._unscopedStyle){const e=qe(t);e.setAttribute(Ve,""),t._unscopedStyle=e}else t._style||(t._style=qe(t));e.push(i?t._unscopedStyle:t._style)}}return e}function Ge(t){let e=je(t);if(e&&void 0===e._cssText){let t=function(t){let e="",i=Ye(t);for(let t=0;t<i.length;t++)e+=i[t].textContent;return e}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
 ...
 * Google as part of the polymer project is also subject to an additional IP
 * rights grant found at http://polymer.github.io/PATENTS.txt
 */let _o=null,bo="";function yo(){bo=document.documentElement.getAttribute("dir")}function vo(t){if(!t.__autoDirOptOut){t.setAttribute("dir",bo)}}function wo(){yo(),bo=document.documentElement.getAttribute("dir");for(let t=0;t<go.length;t++)vo(go[t])}const xo=Me(t=>{mo||_o||(yo(),_o=new MutationObserver(wo),_o.observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]}));const e=ki(t);class i extends e{static _processStyleText(t,i){return t=e._processStyleText.call(this,t,i),!mo&&fo.test(t)&&(t=this._replaceDirInCssText(t),this.__activateDir=!0),t}static _replaceDirInCssText(t){let e=t;return e=e.replace(uo,':host([dir="$1"])'),e=e.replace(po,':host([dir="$2"]) $1'),e}constructor(){super(),this.__autoDirOptOut=!1}ready(){super.ready(),this.__autoDirOptOut=this.hasAttribute("dir")}connectedCallback(){e.prototype.connectedCallback&&super.connectedCallback(),this.constructor.__activateDir&&(_o&&_o.takeRecords().length&&wo(),go.push(this),vo(this))}disconnectedCallback(){if(e.prototype.disconnectedCallback&&super.disconnectedCallback(),this.constructor.__activateDir){const t=go.indexOf(this);t>-1&&go.splice(t,1)}}}return i.__activateDir=!1,i});
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
let un=!1;function pn(){if(Ee&&!ye){if(!un){un=!0;const t=document.createElement("style");t.textContent="dom-bind,dom-if,dom-repeat{display:none;}",document.head.appendChild(t)}return!0}return!1}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const Pn=new ce;window.ShadyCSS||(window.ShadyCSS={prepareTemplate(t,e,i){},prepareTemplateDom(t,e){},prepareTemplateStyles(t,e,i){},styleSubtree(t,e){Pn.processStyles(),Ft(t,e)},styleElement(t){Pn.processStyles()},styleDocument(t){Pn.processStyles(),Ft(document.body,t)},getComputedStyleValue:(t,e)=>Bt(t,e),flushCustomStyles(){},nativeCss:mt,nativeShadow:ht,cssBuild:ut,disableRuntime:ft}),window.ShadyCSS.CustomStyleInterface=Pn;
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */;const lc=Symbol.for(""),cc=t=>{if(t?.r===lc)return t?._$litStatic$},hc=(t,...e)=>({_$litStatic$:e.reduce((e,i,r)=>e+(t=>{if(void 0!==t._$litStatic$)return t._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${t}. Use 'unsafeStatic' to pass non-literal values, but\n            take care to ensure page security.`)})(i)+t[r+1],t[0]),r:lc}),dc=new Map,uc=(t=>(e,...i)=>{const r=i.length;let o,n;const s=[],a=[];let l,c=0,h=!1;for(;c<r;){for(l=e[c];c<r&&void 0!==(n=i[c],o=cc(n));)l+=o+e[++c],h=!0;c!==r&&a.push(n),s.push(l),c++}if(c===r&&s.push(e[r]),h){const t=s.join("$$lit$$");void 0===(e=dc.get(t))&&(s.raw=s,dc.set(t,e=s)),i=a}return t(e,...i)})(U);var pc=class extends Ss{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}render(){const t=!!this.href,e=t?hc`a`:hc`button`;return uc`
      <${e}
        part="base"
  ...
  `];render(){return U`
      ...
      `}constructor(){super();const t=new Date,e=JSON.parse(localStorage.getItem("apiKey"));t>=e?.expiry&&localStorage.removeItem("apiKey");const i=JSON.parse(localStorage.getItem("db"));t>=i?.expiry&&localStorage.removeItem("db"),this.logoLink="",this.companyName="",this.supportNum="",this.supportEmail="",this._pages=[],this._email="",this._gravatarSrc=this.#i(this._email),this._apiKey=JSON.parse(localStorage.getItem("apiKey"))?.data||"",this._currentDb=JSON.parse(localStorage.getItem("db"))?.data||"",this._apiKey&&this.#r(),window.addEventListener("apiChange",async t=>{this._apiKey=t.detail?.key,this._currentDb=t.detail?.db,this._apiKey?await this.#r():this.requestUpdate()})}#e(){localStorage.removeItem("apiKey"),localStorage.removeItem("db"),window.dispatchEvent(new CustomEvent("apiChange",{detail:null}))}#i(t){if(!t)return"";return`https://www.gravatar.com/avatar/${SparkMD5.hash(t)}?s=100&d=blank`}#t(t){const e=t.currentTarget.innerText.toLowerCase(),i=this._pages.filter(t=>t.name==e)[0],r="https://"+this._currentDb+".katapultpro.com/"+i.url;window.open(r,"_blank")}async#r(){const t=""!=this._currentDb?this._currentDb+".":"";setTimeout(async()=>{if(this._apiKey){const e=await fetch(`https://${t}katapultpro.com/api/v2/company-data/pages?api_key=${this._apiKey}`,{method:"GET"}).then(t=>t.json());e.error||(e.forEach(t=>{t.displayName=t.name.length>20?t.name.slice(0,15)+"...":t.name,t.icon=t.icon+"_round"}),this._pages=e,this.requestUpdate())}},2500)}}window.customElements.define("katapult-toolbar",gc);var _c=new WeakMap,bc=new WeakMap,yc=new WeakMap,vc=new WeakSet,wc=new WeakMap,xc=class{constructor(t,e){this.handleFormData=t=>{const e=this.options.disabled(this.host),i=this.options.name(this.host),r=this.options.value(this.host),o="sl-button"===this.host.tagName.toLowerCase();this.host.isConnected&&!e&&!o&&"string"==typeof i&&i.length>0&&void 0!==r&&(Array.isArray(r)?r.forEach(e=>{t.formData.append(i,e.toString())}):t.formData.append(i,r.toString()))},this.handleFormSubmit=t=>{var e;const i=this.options.disabled(this.host),r=this.options.reportValidity;this.form&&!this.form.noValidate&&(null==(e=_c.get(this.form))||e.forEach(t=>{this.setUserInteracted(t,!0)})),!this.form||this.form.noValidate||i||r(this.host)||(t.preventDefault(),t.stopImmediatePropagation())},this.handleFormReset=()=>{this.options.setValue(this.host,this.options.defaultValue(this.host)),this.setUserInteracted(this.host,!1),wc.set(this.host,[])},this.handleInteraction=t=>{const e=wc.get(this.host);e.includes(t.type)||e.push(t.type),e.length===this.options.assumeInteractionOn.length&&this.setUserInteracted(this.host,!0)},this.checkFormValidity=()=>{if(this.form&&!this.form.noValidate){const t=this.form.querySelectorAll("*");for(const e of t)if("function"==typeof e.checkValidity&&!e.checkValidity())return!1}return!0},this.reportFormValidity=()=>{if(this.form&&!this.form.noValidate){const t=this.form.querySelectorAll("*");for(const e of t)if("function"==typeof e.reportValidity&&!e.reportValidity())return!1}return!0},(this.host=t).addController(this),this.options=Kn({form:t=>{const e=t.form;if(e){const i=t.getRootNode().querySelector(`#${e}`);if(i)return i}return t.closest("form")},name:t=>t.name,value:t=>t.value,defaultValue:t=>t.defaultValue,disabled:t=>{var e;return null!=(e=t.disabled)&&e},reportValidity:t=>"function"!=typeof t.reportValidity||t.reportValidity(),checkValidity:t=>"function"!=typeof t.checkValidity||t.checkValidity(),setValue:(t,e)=>t.value=e,assumeInteractionOn:["sl-input"]},e)}hostConnected(){const t=this.options.form(this.host);t&&this.attachForm(t),wc.set(this.host,[]),this.options.assumeInteractionOn.forEach(t=>{this.host.addEventListener(t,this.handleInteraction)})}hostDisconnected(){this.detachForm(),wc.delete(this.host),this.options.assumeInteractionOn.forEach(t=>{this.host.removeEventListener(t,this.handleInteraction)})}hostUpdated(){const t=this.options.form(this.host);t||this.detachForm(),t&&this.form!==t&&(this.detachForm(),this.attachForm(t)),this.host.hasUpdated&&this.setValidity(this.host.validity.valid)}attachForm(t){t?(this.form=t,_c.has(this.form)?_c.get(this.form).add(this.host):_c.set(this.form,new Set([this.host])),this.form.addEventListener("formdata",this.handleFormData),this.form.addEventListener("submit",this.handleFormSubmit),this.form.addEventListener("reset",this.handleFormReset),bc.has(this.form)||(bc.set(this.form,this.form.reportValidity),this.form.reportValidity=()=>this.reportFormValidity()),yc.has(this.form)||(yc.set(this.form,this.form.checkValidity),this.form.checkValidity=()=>this.checkFormValidity())):this.form=void 0}detachForm(){if(!this.form)return;const t=_c.get(this.form);t&&(t.delete(this.host),t.size<=0&&(this.form.removeEventListener("formdata",this.handleFormData),this.form.removeEventListener("submit",this.handleFormSubmit),this.form.removeEventListener("reset",this.handleFormReset),bc.has(this.form)&&(this.form.reportValidity=bc.get(this.form),bc.delete(this.form)),yc.has(this.form)&&(this.form.checkValidity=yc.get(this.form),yc.delete(this.form)),this.form=void 0))}setUserInteracted(t,e){e?vc.add(t):vc.delete(t),t.requestUpdate()}doAction(t,e){if(this.form){const i=document.createElement("button");i.type=t,i.style.position="absolute",i.style.width="0",i.style.height="0",i.style.clipPath="inset(50%)",i.style.overflow="hidden",i.style.whiteSpace="nowrap",e&&(i.name=e.name,i.value=e.value,["formaction","formenctype","formmethod","formnovalidate","formtarget"].forEach(t=>{e.hasAttribute(t)&&i.setAttribute(t,e.getAttribute(t))})),this.form.append(i),i.click(),i.remove()}}getForm(){var t;return null!=(t=this.form)?t:null}reset(t){this.doAction("reset",t)}submit(t){this.doAction("submit",t)}setValidity(t){const e=this.host,i=Boolean(vc.has(e)),r=Boolean(e.required);e.toggleAttribute("data-required",r),e.toggleAttribute("data-optional",!r),e.toggleAttribute("data-invalid",!t),e.toggleAttribute("data-valid",t),e.toggleAttribute("data-user-invalid",!t&&i),e.toggleAttribute("data-user-valid",t&&i)}updateValidity(){const t=this.host;this.setValidity(t.validity.valid)}emitInvalidEvent(t){const e=new CustomEvent("sl-invalid",{bubbles:!1,composed:!1,cancelable:!0,detail:{}});t||e.preventDefault(),this.host.dispatchEvent(e)||null==t||t.preventDefault()}},Cc=Object.freeze({badInput:!1,customError:!1,patternMismatch:!1,rangeOverflow:!1,rangeUnderflow:!1,stepMismatch:!1,tooLong:!1,tooShort:!1,typeMismatch:!1,valid:!0,valueMissing:!1});Object.freeze(Jn(Kn({},Cc),{valid:!1,valueMissing:!0})),Object.freeze(Jn(Kn({},Cc),{valid:!1,customError:!0}));var Sc=s`
  :host {
    display: inline-block;
    position: relative;
    width: auto;
...
`,kc=class extends Ss{constructor(){super(...arguments),this.formControlController=new xc(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new Vl(this,"[default]","prefix","suffix"),this.localize=new gs(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:Cc}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(){"submit"===this.type&&this.formControlController.submit(this),"reset"===this.type&&this.formControlController.reset(this)}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}checkValidity(){return!this.isButton()||this.button.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return!this.isButton()||this.button.reportValidity()}setCustomValidity(t){this.isButton()&&(this.button.setCustomValidity(t),this.formControlController.updateValidity())}render(){const t=this.isLink(),e=t?hc`a`:hc`button`;return uc`
      <${e}
        part="base"
    ...
    `}};kc.styles=[_s,Sc],kc.dependencies={"sl-icon":rc,"sl-spinner":Ul},Yn([xs(".button")],kc.prototype,"button",2),Yn([ws()],kc.prototype,"hasFocus",2),Yn([ws()],kc.prototype,"invalid",2),Yn([vs()],kc.prototype,"title",2),Yn([vs({reflect:!0})],kc.prototype,"variant",2),Yn([vs({reflect:!0})],kc.prototype,"size",2),Yn([vs({type:Boolean,reflect:!0})],kc.prototype,"caret",2),Yn([vs({type:Boolean,reflect:!0})],kc.prototype,"disabled",2),Yn([vs({type:Boolean,reflect:!0})],kc.prototype,"loading",2),Yn([vs({type:Boolean,reflect:!0})],kc.prototype,"outline",2),Yn([vs({type:Boolean,reflect:!0})],kc.prototype,"pill",2),Yn([vs({type:Boolean,reflect:!0})],kc.prototype,"circle",2),Yn([vs()],kc.prototype,"type",2),Yn([vs()],kc.prototype,"name",2),Yn([vs()],kc.prototype,"value",2),Yn([vs()],kc.prototype,"href",2),Yn([vs()],kc.prototype,"target",2),Yn([vs()],kc.prototype,"rel",2),Yn([vs()],kc.prototype,"download",2),Yn([vs()],kc.prototype,"form",2),Yn([vs({attribute:"formaction"})],kc.prototype,"formAction",2),Yn([vs({attribute:"formenctype"})],kc.prototype,"formEnctype",2),Yn([vs({attribute:"formmethod"})],kc.prototype,"formMethod",2),Yn([vs({attribute:"formnovalidate",type:Boolean})],kc.prototype,"formNoValidate",2),Yn([vs({attribute:"formtarget"})],kc.prototype,"formTarget",2),Yn([ml("disabled",{waitUntilFirstUpdate:!0})],kc.prototype,"handleDisabledChange",1),kc.define("sl-button");var Ec=[],Pc=class{constructor(t){this.tabDirection="forward",this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=t=>{var e;if("Tab"!==t.key||this.isExternalActivated)return;if(!this.isActive())return;const i=Qn();if(this.previousFocus=i,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;t.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const r=rs(this.element);let o=r.findIndex(t=>t===i);this.previousFocus=this.currentFocus;const n="forward"===this.tabDirection?1:-1;for(;;){o+n>=r.length?o=0:o+n<0?o=r.length-1:o+=n,this.previousFocus=this.currentFocus;const i=r[o];if("backward"===this.tabDirection&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;if(i&&this.possiblyHasTabbableChildren(i))return;t.preventDefault(),this.currentFocus=i,null==(e=this.currentFocus)||e.focus({preventScroll:!1});const s=[...Zn()];if(s.includes(this.currentFocus)||!s.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=t,this.elementsWithTabbableControls=["iframe"]}activate(){Ec.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){Ec=Ec.filter(t=>t!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return Ec[Ec.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const t=rs(this.element);if(!this.element.matches(":focus-within")){const e=t[0],i=t[t.length-1],r="forward"===this.tabDirection?e:i;"function"==typeof(null==r?void 0:r.focus)&&(this.currentFocus=r,r.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(t){return this.elementsWithTabbableControls.includes(t.tagName.toLowerCase())||t.hasAttribute("controls")}},Ac=new Set;function $c(t){if(Ac.add(t),!document.documentElement.classList.contains("sl-scroll-lock")){const t=function(){const t=document.documentElement.clientWidth;return Math.abs(window.innerWidth-t)}()+function(){const t=Number(getComputedStyle(document.body).paddingRight.replace(/px/,""));return isNaN(t)||!t?0:t}();let e=getComputedStyle(document.documentElement).scrollbarGutter;e&&"auto"!==e||(e="stable"),t<2&&(e=""),document.documentElement.style.setProperty("--sl-scroll-lock-gutter",e),document.documentElement.classList.add("sl-scroll-lock"),document.documentElement.style.setProperty("--sl-scroll-lock-size",`${t}px`)}}function Tc(t){Ac.delete(t),0===Ac.size&&(document.documentElement.classList.remove("sl-scroll-lock"),document.documentElement.style.removeProperty("--sl-scroll-lock-size"))}var Oc=s`
  :host {
    --width: 31rem;
...
`,Ic=class extends Ss{constructor(){super(...arguments),this.hasSlotController=new Vl(this,"footer"),this.localize=new gs(this),this.modal=new Pc(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=t=>{"Escape"===t.key&&this.modal.isActive()&&this.open&&(t.stopPropagation(),this.requestClose("keyboard"))}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),$c(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),Tc(this),this.removeOpenListeners()}requestClose(t){if(this.emit("sl-request-close",{cancelable:!0,detail:{source:t}}).defaultPrevented){const t=hl(this,"dialog.denyClose",{dir:this.localize.dir()});return void ul(this.panel,t.keyframes,t.options)}this.hide()}addOpenListeners(){var t;"CloseWatcher"in window?(null==(t=this.closeWatcher)||t.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard")):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){var t;null==(t=this.closeWatcher)||t.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),$c(this);const t=this.querySelector("[autofocus]");t&&t.removeAttribute("autofocus"),await Promise.all([fl(this.dialog),fl(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("sl-initial-focus",{cancelable:!0}).defaultPrevented||(t?t.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),t&&t.setAttribute("autofocus","")});const e=hl(this,"dialog.show",{dir:this.localize.dir()}),i=hl(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([ul(this.panel,e.keyframes,e.options),ul(this.overlay,i.keyframes,i.options)]),this.emit("sl-after-show")}else{(t=>{var e;const{activeElement:i}=document;i&&t.contains(i)&&(null==(e=document.activeElement)||e.blur())})(this),this.emit("sl-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([fl(this.dialog),fl(this.overlay)]);const t=hl(this,"dialog.hide",{dir:this.localize.dir()}),e=hl(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([ul(this.overlay,e.keyframes,e.options).then(()=>{this.overlay.hidden=!0}),ul(this.panel,t.keyframes,t.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,Tc(this);const i=this.originalTrigger;"function"==typeof(null==i?void 0:i.focus)&&setTimeout(()=>i.focus()),this.emit("sl-after-hide")}}async show(){if(!this.open)return this.open=!0,dl(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,dl(this,"sl-after-hide")}render(){return U`
      <div
        part="base"
    ...
    `}};Ic.styles=[_s,Oc],Ic.dependencies={"sl-icon-button":pc},Yn([xs(".dialog")],Ic.prototype,"dialog",2),Yn([xs(".dialog__panel")],Ic.prototype,"panel",2),Yn([xs(".dialog__overlay")],Ic.prototype,"overlay",2),Yn([vs({type:Boolean,reflect:!0})],Ic.prototype,"open",2),Yn([vs({reflect:!0})],Ic.prototype,"label",2),Yn([vs({attribute:"no-header",type:Boolean,reflect:!0})],Ic.prototype,"noHeader",2),Yn([ml("open",{waitUntilFirstUpdate:!0})],Ic.prototype,"handleOpenChange",1),cl("dialog.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}}),cl("dialog.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}}),cl("dialog.denyClose",{keyframes:[{scale:1},{scale:1.02},{scale:1}],options:{duration:250}}),cl("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}}),cl("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}}),Ic.define("sl-dialog");var Nc=s`
  :host {
    display: block;
  }
...
`,Lc=(t="value")=>(e,i)=>{const r=e.constructor,o=r.prototype.attributeChangedCallback;r.prototype.attributeChangedCallback=function(e,n,s){var a;const l=r.getPropertyOptions(t);if(e===("string"==typeof l.attribute?l.attribute:t)){const e=l.converter||y,r=("function"==typeof e?e:null!=(a=null==e?void 0:e.fromAttribute)?a:y.fromAttribute)(s,l.type);this[t]!==r&&(this[i]=r)}o.call(this,e,n,s)}},zc=s`
 ...
 */;const Dc=tl(class extends el{constructor(t){if(super(t),t.type!==Za&&t.type!==Ga&&t.type!==Qa)throw Error("The `live` directive is not allowed on child or event bindings");if(!xl(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===V||e===j)return e;const i=t.element,r=t.name;if(t.type===Za){if(e===i[r])return V}else if(t.type===Qa){if(!!e===i.hasAttribute(r))return V}else if(t.type===Ga&&i.getAttribute(r)===e+"")return V;return Pl(t),e}});var Mc=class extends Ss{constructor(){super(...arguments),this.formControlController=new xc(this,{assumeInteractionOn:["sl-blur","sl-input"]}),this.hasSlotController=new Vl(this,"help-text","label"),this.localize=new gs(this),this.hasFocus=!1,this.title="",this.__numberInput=Object.assign(document.createElement("input"),{type:"number"}),this.__dateInput=Object.assign(document.createElement("input"),{type:"date"}),this.type="text",this.name="",this.value="",this.defaultValue="",this.size="medium",this.filled=!1,this.pill=!1,this.label="",this.helpText="",this.clearable=!1,this.disabled=!1,this.placeholder="",this.readonly=!1,this.passwordToggle=!1,this.passwordVisible=!1,this.noSpinButtons=!1,this.form="",this.required=!1,this.spellcheck=!0}get valueAsDate(){var t;return this.__dateInput.type=this.type,this.__dateInput.value=this.value,(null==(t=this.input)?void 0:t.valueAsDate)||this.__dateInput.valueAsDate}set valueAsDate(t){this.__dateInput.type=this.type,this.__dateInput.valueAsDate=t,this.value=this.__dateInput.value}get valueAsNumber(){var t;return this.__numberInput.value=this.value,(null==(t=this.input)?void 0:t.valueAsNumber)||this.__numberInput.valueAsNumber}set valueAsNumber(t){this.__numberInput.valueAsNumber=t,this.value=this.__numberInput.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleChange(){this.value=this.input.value,this.emit("sl-change")}handleClearClick(t){t.preventDefault(),""!==this.value&&(this.value="",this.emit("sl-clear"),this.emit("sl-input"),this.emit("sl-change")),this.input.focus()}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleInput(){this.value=this.input.value,this.formControlController.updateValidity(),this.emit("sl-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleKeyDown(t){const e=t.metaKey||t.ctrlKey||t.shiftKey||t.altKey;"Enter"!==t.key||e||setTimeout(()=>{t.defaultPrevented||t.isComposing||this.formControlController.submit()})}handlePasswordToggle(){this.passwordVisible=!this.passwordVisible}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStepChange(){this.input.step=String(this.step),this.formControlController.updateValidity()}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(t){this.input.focus(t)}blur(){this.input.blur()}select(){this.input.select()}setSelectionRange(t,e,i="none"){this.input.setSelectionRange(t,e,i)}setRangeText(t,e,i,r="preserve"){const o=null!=e?e:this.input.selectionStart,n=null!=i?i:this.input.selectionEnd;this.input.setRangeText(t,o,n,r),this.value!==this.input.value&&(this.value=this.input.value)}showPicker(){"showPicker"in HTMLInputElement.prototype&&this.input.showPicker()}stepUp(){this.input.stepUp(),this.value!==this.input.value&&(this.value=this.input.value)}stepDown(){this.input.stepDown(),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("label"),e=this.hasSlotController.test("help-text"),i=!!this.label||!!t,r=!!this.helpText||!!e,o=this.clearable&&!this.disabled&&!this.readonly&&("number"==typeof this.value||this.value.length>0);return U`
    ...
    `}};Mc.styles=[_s,zc,Nc],Mc.dependencies={"sl-icon":rc},Yn([xs(".input__control")],Mc.prototype,"input",2),Yn([ws()],Mc.prototype,"hasFocus",2),Yn([vs()],Mc.prototype,"title",2),Yn([vs({reflect:!0})],Mc.prototype,"type",2),Yn([vs()],Mc.prototype,"name",2),Yn([vs()],Mc.prototype,"value",2),Yn([Lc()],Mc.prototype,"defaultValue",2),Yn([vs({reflect:!0})],Mc.prototype,"size",2),Yn([vs({type:Boolean,reflect:!0})],Mc.prototype,"filled",2),Yn([vs({type:Boolean,reflect:!0})],Mc.prototype,"pill",2),Yn([vs()],Mc.prototype,"label",2),Yn([vs({attribute:"help-text"})],Mc.prototype,"helpText",2),Yn([vs({type:Boolean})],Mc.prototype,"clearable",2),Yn([vs({type:Boolean,reflect:!0})],Mc.prototype,"disabled",2),Yn([vs()],Mc.prototype,"placeholder",2),Yn([vs({type:Boolean,reflect:!0})],Mc.prototype,"readonly",2),Yn([vs({attribute:"password-toggle",type:Boolean})],Mc.prototype,"passwordToggle",2),Yn([vs({attribute:"password-visible",type:Boolean})],Mc.prototype,"passwordVisible",2),Yn([vs({attribute:"no-spin-buttons",type:Boolean})],Mc.prototype,"noSpinButtons",2),Yn([vs({reflect:!0})],Mc.prototype,"form",2),Yn([vs({type:Boolean,reflect:!0})],Mc.prototype,"required",2),Yn([vs()],Mc.prototype,"pattern",2),Yn([vs({type:Number})],Mc.prototype,"minlength",2),Yn([vs({type:Number})],Mc.prototype,"maxlength",2),Yn([vs()],Mc.prototype,"min",2),Yn([vs()],Mc.prototype,"max",2),Yn([vs()],Mc.prototype,"step",2),Yn([vs()],Mc.prototype,"autocapitalize",2),Yn([vs()],Mc.prototype,"autocorrect",2),Yn([vs()],Mc.prototype,"autocomplete",2),Yn([vs({type:Boolean})],Mc.prototype,"autofocus",2),Yn([vs()],Mc.prototype,"enterkeyhint",2),Yn([vs({type:Boolean,converter:{fromAttribute:t=>!(!t||"false"===t),toAttribute:t=>t?"true":"false"}})],Mc.prototype,"spellcheck",2),Yn([vs()],Mc.prototype,"inputmode",2),Yn([ml("disabled",{waitUntilFirstUpdate:!0})],Mc.prototype,"handleDisabledChange",1),Yn([ml("step",{waitUntilFirstUpdate:!0})],Mc.prototype,"handleStepChange",1),Yn([ml("value",{waitUntilFirstUpdate:!0})],Mc.prototype,"handleValueChange",1),Mc.define("sl-input");var Rc=s`
  :host {
    display: inline-block;
  }
...
`,Fc=class extends Ss{constructor(){super(...arguments),this.formControlController=new xc(this,{value:t=>t.checked?t.value||"on":void 0,defaultValue:t=>t.defaultChecked,setValue:(t,e)=>t.checked=e}),this.hasSlotController=new Vl(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.indeterminate=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleClick(){this.checked=!this.checked,this.indeterminate=!1,this.emit("sl-change")}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleInput(){this.emit("sl-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(t){this.input.focus(t)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("help-text"),e=!!this.helpText||!!t;return U`
      <div
      ...
      >
        ...
        >
          <input
            ...
            name=${this.name}
            value=${gl(this.value)}
            .indeterminate=${Dc(this.indeterminate)}
            .checked=${Dc(this.checked)}
            .disabled=${this.disabled}
            .required=${this.required}
    ...
    `}};Fc.styles=[_s,zc,Rc],Fc.dependencies={"sl-icon":rc},Yn([xs('input[type="checkbox"]')],Fc.prototype,"input",2),Yn([ws()],Fc.prototype,"hasFocus",2),Yn([vs()],Fc.prototype,"title",2),Yn([vs()],Fc.prototype,"name",2),Yn([vs()],Fc.prototype,"value",2),Yn([vs({reflect:!0})],Fc.prototype,"size",2),Yn([vs({type:Boolean,reflect:!0})],Fc.prototype,"disabled",2),Yn([vs({type:Boolean,reflect:!0})],Fc.prototype,"checked",2),Yn([vs({type:Boolean,reflect:!0})],Fc.prototype,"indeterminate",2),Yn([Lc("checked")],Fc.prototype,"defaultChecked",2),Yn([vs({reflect:!0})],Fc.prototype,"form",2),Yn([vs({type:Boolean,reflect:!0})],Fc.prototype,"required",2),Yn([vs({attribute:"help-text"})],Fc.prototype,"helpText",2),Yn([ml("disabled",{waitUntilFirstUpdate:!0})],Fc.prototype,"handleDisabledChange",1),Yn([ml(["checked","indeterminate"],{waitUntilFirstUpdate:!0})],Fc.prototype,"handleStateChange",1),Fc.define("sl-checkbox");class Bc extends st{static properties={_validApiKey:{type:Boolean,state:!0},_apiError:{type:Boolean,state:!0},_saveApiData:{type:Boolean}};static styles=[n(Nn),n(mc),s`
    ...
    `];render(){return U`
      ...
      <sl-dialog id="loginForm" no-header .open=${!this._validApiKey} @sl-request-close=${t=>t.preventDefault()}>
        ...
        <div flex column slot="footer">
          <sl-button variant="primary" @click=${()=>this.#o()}>Open API Tool</sl-button>
...
`;class hh extends st{static DEFAULT_RENDER_ITEM=function(t,e,i){return U` <sl-menu-item value=${t.value} ?disabled=${t?.disabled}>${t.label}</sl-menu-item>`};static properties={open:{type:Boolean,reflect:!0},placement:{type:String},stayOpenOnSelect:{type:Boolean,attribute:"stay-open-on-select",reflect:!0},containingElement:{type:Object},hoist:{type:Boolean},autocomplete:{type:String},size:{type:String},filled:{type:Boolean},pill:{type:Boolean},label:{type:String},helpText:{type:String},clearable:{type:Boolean},placeholder:{type:String},disabled:{type:Boolean},items:{type:Array,shouldUpdate:!1},value:{type:String,shouldUpdate:!1},renderItem:{type:Function},autoFilter:{type:Boolean,attribute:"auto-filter",reflect:!0,shouldUpdate:!1},lookLikePaperElement:{type:Boolean,attribute:"look-like-paper-element",reflect:!0},_filteredItems:{type:Array,state:!0},_userInput:{type:String,shouldUpdate:!1,state:!0},_valueLabel:{type:String,shouldUpdate:!1,state:!0},_inputValue:{type:String,state:!0},_virtualizerRange:{type:Object,state:!0,shouldUpdate:!1},_highlightIndex:{type:Number,state:!0,shouldUpdate:!1},_highlightElement:{type:Object,state:!0,shouldUpdate:!1},_selectedElement:{type:Object,state:!0,shouldUpdate:!1}};static styles=[ch,n(zn),s`
    ...
    `}constructor(){super(),this._inputRef=Dl(),this._dropdownRef=Dl(),this._virtualizerRef=Dl(),this.open=!1,this.placement="bottom",this.disabled=!1,this.stayOpenOnSelect=!1,this.containingElement=void 0,this.hoist=!1,this.autocomplete="off",this.size="medium",this.filled=!1,this.pill=!1,this.label="",this.helpText="",this.clearable=!1,this.placeholder="",this.items=[],this.value="",this.renderItem=hh.DEFAULT_RENDER_ITEM,this.autoFilter=!1,this.lookLikePaperElement=!1,this._filteredItems=[],this._userInput=null,this._inputValue="",this._selectedIndex=-1,this._selectedElement=null,this._highlightIndex=0,this._highlightElement=null,this._virtualizerRange={first:-1,last:-1},this._keydownHandler=t=>{if(t instanceof KeyboardEvent!=!1)switch(t.code){case"ArrowDown":{t.preventDefault();const e=this._filteredItems.length-1,i=this._highlightIndex===e?0:this._highlightIndex+1;this.#c(i);break}case"ArrowUp":{t.preventDefault();const e=this._filteredItems.length-1,i=0===this._highlightIndex?e:this._highlightIndex-1;this.#c(i);break}case"Enter":this.#d()}}}disconnectedCallback(){window.removeEventListener("keydown",this._keydownHandler)}shouldUpdate(t){if(t.has("value")&&(this.value??=""),t.has("disabled")&&this.disabled&&this.hide(),t.has("value")&&this.dispatchEvent(new CustomEvent("value-changed")),t.has("_userInput")&&void 0!==t.get("_userInput")&&this.dispatchEvent(new CustomEvent("user-input",{detail:{value:this._userInput??""}})),["items","_userInput","autoFilter"].some(e=>t.has(e))){const t=this.items??[],e=this._userInput?.trim().toLowerCase()??"";if(this.autoFilter&&""!==e){const i=t.filter(t=>(t.label?.trim().toLowerCase()??"").includes(e));this._filteredItems=i}else this._filteredItems=t}if(["value","items"].some(e=>t.has(e)))if(""===this.value)this._valueLabel="";else{const t=this.items.find(t=>t.value===this.value)?.label??"";""!==t&&(this._valueLabel=t)}["_userInput","_valueLabel"].some(e=>t.has(e))&&(this._inputValue=this._userInput??this._valueLabel??""),["value","_filteredItems"].some(e=>t.has(e))&&(this._selectedIndex=this._filteredItems.findIndex(t=>t.value===this.value)),["_selectedIndex","_virtualizerRange"].some(e=>t.has(e))&&this.#u(),t.has("_selectedElement")&&(t.get("_selectedElement")?.classList.remove("selected"),this._selectedElement?.classList.add("selected")),t.has("_filteredItems")&&this.#c(0,"start"),["_highlightIndex","_filteredItems"].some(e=>t.has(e))&&(this._highlightIndex=this.clamp(this._highlightIndex,0,this._filteredItems.length-1)),["_highlightIndex","_virtualizerRange"].some(e=>t.has(e))&&this.#p(),t.has("_highlightElement")&&(t.get("_highlightElement")?.classList.remove("highlight"),this._highlightElement?.classList.add("highlight"));const e=this.shadowRoot.querySelector("slot[name=label]"),i=this.shadowRoot.querySelector("slot[name=help-text]");let r=!1;if(e||i){const t=!!(e?.innerText||e?.assignedElements()?.length>0),o=!!(i?.innerText||i?.assignedElements()?.length>0);t&&!e.hasAttribute("slot")?(e.setAttribute("slot","label"),r=!0):!t&&e.hasAttribute("slot")&&(e.removeAttribute("slot"),r=!0),o&&!i.hasAttribute("slot")?(i.setAttribute("slot","help-text"),r=!0):!o&&i.hasAttribute("slot")&&(i.removeAttribute("slot"),r=!0)}const o=0==t.size,n=Array.from(t.keys()).some(t=>!1!==this.constructor.properties[t].shouldUpdate);return o||n||r}show(){const t=this._dropdownRef.value;t&&(!0!==t.open&&t.show(),this.#l())}hide(){const t=this._dropdownRef.value;t&&!1!==t.open&&t.hide()}clear(){this.#h(),this.#f("")}clamp(t,e,i){return null==i&&(i=1/0),null==e&&(e=-1/0),t>i?i:t<e?e:t}#a(t){if(!t)return;const e=new CustomEvent("select",{cancelable:!0,detail:{item:t}});if(!this.dispatchEvent(e))return;null!=t.getAttribute("value")&&(this.#f(t.value),this.#h()),this.stayOpenOnSelect||this.hide()}#d(){this.#a(this._highlightElement)}#f(t){const e=t??"";this.value!=e&&(this.value=e,this.dispatchEvent(new CustomEvent("change")))}#h(){this._userInput=null}#u(){const t=this._virtualizerRef.value,e=this._virtualizerRange.first;if(!t||-1===e)return void(this._selectedElement=null);const i=this._selectedIndex-this._virtualizerRange.first,r=t.children[i]??null;this._selectedElement=r}#c(t,e="nearest"){this._highlightIndex=this.clamp(t,0,this._filteredItems.length-1);const i=this._virtualizerRef.value;i?.scrollToIndex(this._highlightIndex,e)}#p(){const t=this._virtualizerRef.value,e=this._virtualizerRange.first;if(!t||-1===e)return void(this._highlightElement=null);const i=this._highlightIndex-this._virtualizerRange.first,r=t.children[i]??null;this._highlightElement=r}#l(){const t=this._inputRef.value;t&&t.focus()}}window.customElements.define("katapult-dropdown",hh);window.customElements.define("katapult-job-dropdown",class extends st{static properties={_jobData:{type:Array,state:!0},_jobNames:{type:Array,state:!0},_apiKey:{type:String},_currentJobData:{type:Object}};render(){return U`
      ...
      ${lt(this._jobNames?.length>0,()=>U`
          ...
          ></katapult-dropdown>
        `)}
    `}constructor(){super();const t=new Date,e=JSON.parse(localStorage.getItem("apiKey"));t>=e?.expiry&&localStorage.removeItem("apiKey");const i=JSON.parse(localStorage.getItem("db"));t>=i?.expiry&&localStorage.removeItem("db"),this._jobData=[],this._jobNames=[],this._apiKey=JSON.parse(localStorage.getItem("apiKey"))?.data||"",this._currentJobData={},window.addEventListener("apiChange",async t=>{this._apiKey=t.detail?.key,this._apiKey?await this.#g(t.detail.db):this.requestUpdate()}),this._apiKey&&this.#g(JSON.parse(localStorage.getItem("db"))?.data)}getSelectedJob(){return this._currentJobData}#m(t){const e=this._jobData.filter(e=>e.name===t.currentTarget.value)[0];this._currentJobData=e,this.dispatchEvent(new CustomEvent("change"))}async#g(t){const e=""!=t?t+".":"";setTimeout(async()=>{const t=await fetch(`https://${e}katapultpro.com/api/v3/jobs?api_key=${this._apiKey}`,{method:"GET"}).then(t=>t.json());this._jobData=t.data,this._jobData&&(this._jobNames=this._jobData.map(t=>({value:t.name,label:t.name}))),this.requestUpdate()},200)}});class dh extends st{static properties={supportNum:{type:String},supportEmail:{type:String},companyName:{type:String},logoLink:{type:String}};static styles=[n(Nn),n(zn),s`
      :root {
    ...
    `}constructor(){super(),this.supportNum="",this.supportEmail="",this.companyName="",this.logoLink="",Xl("material",{resolver:t=>{const e=t.match(/^(.*?)(_(round|sharp))?$/);return`https://material-icons.github.io/material-icons/svg/${e[1]}/${e[3]||"outline"}.svg`},mutator:t=>t.setAttribute("fill","currentColor")}),cl("dropdown.hide",{keyframes:[{opacity:"0"},{opacity:"0"}],options:{duration:100}}),cl("dropdown.show",{keyframes:[{opacity:"1"},{opacity:"1"}],options:{duration:100}})}}window.customElements.define("katapult-page-element",dh);var uh=s`
  :host {
...
`,ph=class extends Ss{constructor(){super(...arguments),this.hasSlotController=new Vl(this,"footer","header","image")}render(){return U`
      <div
        part="base"
    ...
    `}};ph.styles=[_s,uh],ph.define("sl-card");class fh extends st{static properties={jobData:{type:Array}};static styles=[n(mc),s`
      :host {
  ...
  `];render(){return U`
    ...
    `}constructor(){super()}displayJobData(){const t=this.shadowRoot.getElementById("job-dropdown").getSelectedJob();this.jobData=Object.entries(t).map(t=>({name:t[0],value:t[1]}))}}window.customElements.define("main-page",fh);export{fh as MainPage};
